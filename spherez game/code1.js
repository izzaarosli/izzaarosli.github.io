...
gdjs.TutorialCode.asyncCallback11579164 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.TutorialCode.asyncCallback11579164(runtimeScene, asyncObjectsList)));
}
}
...
{
{gdjs.TutorialCode.conditionTrue_1 = gdjs.TutorialCode.condition0IsTrue_0;
gdjs.TutorialCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11846788);
}
}if (gdjs.TutorialCode.condition0IsTrue_0.val) {
